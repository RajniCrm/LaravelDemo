...
<nav class="col-md-2 d-none d-md-block bg-light sidebar">
      <div class="sidebar-sticky">
        <ul class="nav flex-column">
              ...
              <li class="nav-item">
                <a class="nav-link <?php if($segment2 == 'user' && $segment1 == 'admin') echo 'active'; ?>" href="{{ url('/user') }}">
              ...
              @if(auth()->user()->id == '1')
              <li class="nav-item">
                <a class="nav-link <?php if($segment2 == 'roles' && $segment1 == 'admin') echo 'active'; ?>" href="{{ url('/roles') }}">
                  <span data-feather="file"></span> User Roles
                </a>
              </li>
              <li class="nav-item">
                <a class="nav-link <?php if($segment2 == 'cms' && $segment1 == 'admin') echo 'active'; ?>" href="{{ url('/cms') }}">
