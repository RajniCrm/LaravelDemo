      ...
      <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        ...
        <div class="btn-toolbar mb-2 mb-md-0">
          <div class="btn-group mr-2">
            <a href="{{url('/category/create')}}" class="btn btn-sm btn-outline-secondary">Create</a>
          </div>
        </div>
      </div>
          ...
          <?php $status_class = 'btn-danger';  ?>
            <tr>
              ...
              <td>
                  ...
                  <a href="{{action('CategoryController@edit', $row['id'])}}" class="btn btn-xs btn-success">Update</a>
                  <a href="{{action('CategoryController@delete_form',['id'=> encrypt($row['id'])] )}}" class="btn btn-xs btn-danger delete_form"  >Delete  </a>
              </td>
            </tr>
          @endforeach
          @endif
...
<div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    ...
    <form method="post" action="{{route('change_status_cat')}}">
      {{csrf_field()}} 
